...
const Footer = () => {
    return (
        <>
            <div className="h-56 bg-black mt-10">
                <h1 className="text-center py-8 text-4xl font-bold text-white">Join Our Community </h1>
                <div className=" flex gap-4 items-center justify-center ">
                    <input className="p-5 rounded bg-black border-2 border-white" type="email" name="email" placeholder="Enter Your Email" id="" />
                    <button className="p-5 rounded font-semibold bg-white text-black">Submit</button>
                </div>
            </div>
            <div>
                <footer className="footer items-center bg-gray-950 p-8 text-neutral-content">
