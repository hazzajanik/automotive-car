...
// custom login Method--->
    ...
    return (
        <div className=" pb-20">
            ...
            <div className="card flex-shrink-0 mx-auto w-full max-w-sm bg-zinc-200">
                <form onSubmit={hundleLogin}  className="card-body" >
                    ...
                    <div className="form-control mt-6">
                        <button className="btn bg-black rounded-3xl text-white font-semibold hover:bg-slate-600">Login</button>
                    </div>
                </form>
            </div>
                ...
                <button onClick={hundleGoogleSignIn} className="btn bg-black w-72   rounded-3xl text-white font-semibold hover:bg-zinc-900">Login With Google</button>
                </div>
